const dashboardTemplate = (context, html, items) => html`
...
async function dashboardPage(context) {
    const data = await context.prepareView.dataAPI.getAllFurniture();
    const view = dashboardTemplate(context, context.prepareView.html, data);
    context.prepareView.setUserNavigation("catalogLink");
