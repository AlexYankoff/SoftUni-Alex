...
async function addCath(){
    // трябва да имаме event за адд формата, който вика тази функция
    //взимаме всичко от формата
...
function createOneCatchElem(object) {
    console.log('влизаме в createOneCatchElem')
    console.log(object)
    console.log('това по-горе е обекта')
    const [_ownerId, angler,weight,species,location,bait,captureTime,idTo,oneMore] = object
    
    console.log(`towa li e ${oneMore}`)
    ...
    const oneCatch = e('div',{id:oneMore, className:'catch'},
        ...
        //oneCatch.getElementsByTagName('div')[0].id = 'PROBA'
...
async function loadCathes(){
    ...
    //const listArr = Object.values(catchesList) - няма нужда, защото си е масив
    console.log('масив')
    //console.log(catchesList)
